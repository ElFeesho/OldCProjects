...
GtkWidget *banner_create(char *text, short size)
{
	...
	gtk_widget_modify_bg(banner_box,GTK_STATE_NORMAL,banner_create_color(0,32768,65535));
	...
	gtk_widget_modify_fg(banner_label,GTK_STATE_NORMAL,banner_create_color(65535,65535,65535));
	gtk_widget_modify_fg(banner_label,GTK_STATE_ACTIVE,banner_create_color(65535,65535,65535));
	gtk_widget_modify_fg(banner_label,GTK_STATE_INSENSITIVE,banner_create_color(65535,65535,65535));
